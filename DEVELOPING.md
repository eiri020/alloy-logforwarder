# Alloy Logforwarder Developer Notes

Home Assistant app for forwarding Home Assistant logs to the central
Loki/Alloy logging stack.

End-user documentation is available in [DOCS.md](DOCS.md). This file is for
development, local testing, deployment and project maintenance.
...
Home Assistant expects these conventional files in an app/add-on directory:

| File | Purpose |
|---|---|
| `README.md` | Short intro shown in the app store/info context |
| `DOCS.md` | End-user documentation shown as the documentation page |
| `CHANGELOG.md` | Release notes shown around updates |
| `icon.png` | Square app icon, recommended 128x128px |
| `logo.png` | Wider logo, recommended around 250x100px |
| `DEVELOPING.md` | Project-local developer notes; not a Home Assistant convention |

Keep user-facing usage information in `DOCS.md`. Keep build, deploy,
devcontainer and local test information in this file.
